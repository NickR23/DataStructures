...
public class AdjacencyMatrixGraph<V, E> extends AbstractGraph<V, E> {
    ...
    public Vertex<V> removeVertex(Vertex<V> vertex) {
        ...
        {
        		Edge<E> e = matrix[i][vertexMap.get(v)];
        		if (e != null)
        		{
        			removeEdge(e);
        		}
        ...
        for(int i = 0; i < matrix[0].length; i++)
        {
        		Edge<E> e = matrix[vertexMap.get(v)][i];
        		if (e != null)
        		{
        			removeEdge(e);
        		}
    ...
    public Edge<E> removeEdge(Edge<E> edge) {
        ...
        Vertex<V> v1 = validate(v[0]);
        Vertex<V> v2 = validate(v[1]);
        edgeList.remove(e.getPosition());
        matrix[vertexMap.get(v1)][vertexMap.get(v2)] = null;
        return e;
    }
